      ...
      <div className="container">
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroDescription}>
            A modern, enterprise-grade framework powered by Node.js (ESM), modular
            packages, and externalized configuration — delivering unified test
...
const coreFeatures = [
  ...
  {
    icon: '🧩',
    title: 'Package-Driven Modularity',
    description:
      'Install only the package you need — each one provides a ready-to-use driver. Native BDD support via Gherkin for human-readable specifications.',
  },
  {
    icon: '📄',
    ...
    <section className={styles.architecture}>
      <div className="container">
        <div className={styles.sectionHeader}>
          ...
          <p>Clean separation of concerns with package-driven driver selection</p>
        </div>
        <div className={styles.archDiagram}>
          ...
          <div className={styles.archLayer} data-layer="2">
            <div className={styles.archLabel}>Layer 2 — Driver Core</div>
            <div className={styles.archClasses}>
              BaseDriver · UiDriver · ApiDriver · ConfigManager
            </div>
          </div>
