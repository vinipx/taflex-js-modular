    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/vinipx/taflex-js-modular/edit/main/docs/',
      ...
      navbar: {
        ...
        items: [
          ...
          },
          {
            ...
            position: "left",
            items: [
              { label: "System Design", to: "/docs/architecture/overview" },
              { label: "Distribution & Registry Strategy", to: "/docs/architecture/registry-strategy" },
            ],
          },
          {
            type: "dropdown",
          ...
          },
          {
            ...
            items: [
              ...
              { label: "Package Registry", to: "/docs/guides/package-registry" },
